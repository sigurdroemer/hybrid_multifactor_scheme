...
%
% 	Implements the Black-Scholes call price formula. 
%
% -----------------------------------------------------------------------------------------------
% Parameters
% -----------------------------------------------------------------------------------------------
...
%   q:      [Nx1 or ...         Dividend yield (default is 0).
%            1x1 real ...
%            (optional)] 
%
% -----------------------------------------------------------------------------------------------
...
% 
% 	Implements the standard normal CDF. Code is extracted directly from matlabs 'normcdf'. 
%   Speed is improved moderately by bypassing the other code in 'normcdf'.
%
% -----------------------------------------------------------------------------------------------
% Parameter
% -----------------------------------------------------------------------------------------------
%   z:      [MxN real]  Input values.
%
% -----------------------------------------------------------------------------------------------
% Output
% -----------------------------------------------------------------------------------------------
