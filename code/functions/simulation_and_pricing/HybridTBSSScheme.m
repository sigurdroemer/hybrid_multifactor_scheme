...
%
% 	Simulates the truncated Brownian semistationary (TBSS) process
%
...
%   
%   cov_method:   Methods for computing the covariance matrix of the scheme. Options are 'exact' 
...
if isempty(W_bold)
    ...
    if exist('SIGMA','var') && ~isempty(SIGMA)
        ...
        elseif strcmpi(cov_method,'numerical_integration')
            K = KernelFunctionClass(1,alpha,@(obj,s)(1),10^(-12));
