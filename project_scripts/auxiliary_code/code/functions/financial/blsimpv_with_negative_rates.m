...
%
% 	Matlab's 'blsimpv' function do not accept negative interest rates or dividend yields. 
...
%   idxCall:    [MxN logical]   True if observed price is for a call option, false for a 
%                               put option.
%   
% -----------------------------------------------------------------------------------------------
% Output
